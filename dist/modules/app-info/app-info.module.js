...
exports.AppInfoModule = void 0;
const common_1 = require("@nestjs/common");
const app_info_controller_1 = require("./app-info.controller");
const app_info_service_1 = require("./app-info.service");
let AppInfoModule = class AppInfoModule {
};
AppInfoModule = __decorate([
    (0, common_1.Module)({
        providers: [app_info_service_1.AppInfoService],
        controllers: [app_info_controller_1.AppInfoController],
    })
], AppInfoModule);
