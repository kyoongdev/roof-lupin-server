/*
  ...
  - You are about to alter the column `startAt` on the `OpenHour` table. The data in that column could be lost. The data in that column will be cast from `Char(2)` to `TinyInt`.
  - You are about to alter the column `endAt` on the `OpenHour` table. The data in that column could be lost. The data in that column will be cast from `Char(2)` to `TinyInt`.
...
-- AlterTable
ALTER TABLE `OpenHour` MODIFY `startAt` TINYINT NOT NULL,
    MODIFY `endAt` TINYINT NOT NULL;
