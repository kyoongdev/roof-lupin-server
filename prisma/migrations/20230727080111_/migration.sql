/*
  ...
  - You are about to drop the column `order` on the `FrequentQuestion` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `FrequentQuestion` DROP COLUMN `order`;
