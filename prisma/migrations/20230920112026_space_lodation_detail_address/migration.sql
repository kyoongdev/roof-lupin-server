/*
  ...
  - Added the required column `detailAddress` to the `SpaceLocation` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `SpaceLocation` ADD COLUMN `detailAddress` VARCHAR(191) NOT NULL;
