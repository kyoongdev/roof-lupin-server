/*
  ...
  - You are about to drop the column `orderNo` on the `CategoryIcon` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `Category` ADD COLUMN `orderNo` TINYINT NULL;

-- AlterTable
ALTER TABLE `CategoryIcon` DROP COLUMN `orderNo`;
