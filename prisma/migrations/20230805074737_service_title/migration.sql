/*
  ...
  - You are about to alter the column `name` on the `Service` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `VarChar(20)`.
...
-- AlterTable
ALTER TABLE `Service` ADD COLUMN `serviceTitleId` VARCHAR(191) NULL,
