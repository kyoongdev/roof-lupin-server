/*
  ...
  - You are about to alter the column `floor` on the `SpaceSize` table. The data in that column could be lost. The data in that column will be cast from `VarChar(10)` to `TinyInt`.
...
-- AlterTable
ALTER TABLE `SpaceSize` MODIFY `floor` TINYINT NOT NULL;
