/*
  ...
  - A unique constraint covering the columns `[spaceId]` on the table `RefundPolicy` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `RefundPolicy_spaceId_key` ON `RefundPolicy`(`spaceId`);
