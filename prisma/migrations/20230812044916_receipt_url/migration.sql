/*
  ...
  - You are about to drop the column `recieptUrl` on the `Reservation` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Reservation` DROP COLUMN `recieptUrl`,
    ADD COLUMN `receiptUrl` VARCHAR(255) NULL;
