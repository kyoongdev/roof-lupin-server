...
-- AlterTable
ALTER TABLE `SpaceHoliday` ADD COLUMN `month` TINYINT NULL,
    ADD COLUMN `year` SMALLINT NULL,
    MODIFY `interval` TINYINT NULL;

-- AlterTable
ALTER TABLE `User` ADD COLUMN `isCertified` BOOLEAN NOT NULL DEFAULT false;
