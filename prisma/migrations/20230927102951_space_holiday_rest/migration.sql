/*
  ...
  - You are about to drop the column `isOfficialHolidayRest` on the `Space` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Space` DROP COLUMN `isOfficialHolidayRest`;

-- AlterTable
ALTER TABLE `UserAlarm` ADD COLUMN `thumbnail` VARCHAR(191) NULL;
