/*
  ...
  - You are about to drop the column `deletedAt` on the `BlockedTime` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `BlockedTime` DROP COLUMN `deletedAt`;
