/*
  ...
  - You are about to drop the column `highlight` on the `Category` table. All the data in the column will be lost.
  - You are about to drop the column `isContent` on the `Category` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `Category` DROP COLUMN `highlight`,
    DROP COLUMN `isContent`;
