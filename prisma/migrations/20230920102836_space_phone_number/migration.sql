/*
  ...
  - Added the required column `phoneNumber` to the `Space` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `Space` ADD COLUMN `phoneNumber` VARCHAR(11) NOT NULL;
