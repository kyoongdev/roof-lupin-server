/*
  ...
  - You are about to drop the column `isHolidayRest` on the `Space` table. All the data in the column will be lost.
  - You are about to drop the column `month` on the `SpaceHoliday` table. All the data in the column will be lost.
  - You are about to drop the column `year` on the `SpaceHoliday` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Space` DROP COLUMN `isHolidayRest`;

-- AlterTable
ALTER TABLE `SpaceHoliday` DROP COLUMN `month`,
    DROP COLUMN `year`;
