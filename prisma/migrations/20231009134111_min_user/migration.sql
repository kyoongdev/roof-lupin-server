/*
  ...
  - You are about to drop the column `minUser` on the `Space` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Space` DROP COLUMN `minUser`,
    ADD COLUMN `depositDescription` VARCHAR(120) NULL;
