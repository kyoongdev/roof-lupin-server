/*
  ...
  - You are about to drop the column `reportType` on the `UserReport` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `UserReport` DROP COLUMN `reportType`;
