...
*/
-- AlterTable
ALTER TABLE `ContentCategorySpace` MODIFY `orderNo` INTEGER NULL;

-- AlterTable
ALTER TABLE `Coupon` MODIFY `defaultDueDateStart` DATETIME NULL;

-- AlterTable
ALTER TABLE `Curation` MODIFY `homeOrderNo` INTEGER NULL,
    MODIFY `orderNo` INTEGER NULL;

-- AlterTable
ALTER TABLE `CurationSpace` MODIFY `orderNo` INTEGER NULL;
