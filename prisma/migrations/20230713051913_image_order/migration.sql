/*
  ...
  - You are about to drop the column `orderNo` on the `ExhibitionImage` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `ExhibitionImage` DROP COLUMN `orderNo`;
