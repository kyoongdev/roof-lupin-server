/*
  ...
  - You are about to drop the column `blockReleaseAt` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `User` DROP COLUMN `blockReleaseAt`,
    ADD COLUMN `unBlockAt` DATETIME(3) NULL;
