/*
  ...
  - You are about to drop the column `homeOrderNo` on the `Curation` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Curation` DROP COLUMN `homeOrderNo`;
