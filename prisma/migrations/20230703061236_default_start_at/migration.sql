/*
  ...
  - You are about to drop the column `defualtDueDateStart` on the `Coupon` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `Coupon` DROP COLUMN `defualtDueDateStart`,
    ADD COLUMN `defaultDueDateStart` DATETIME NULL;
