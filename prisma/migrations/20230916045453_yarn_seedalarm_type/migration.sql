/*
  ...
  - Added the required column `alarmType` to the `UserAlarm` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `UserAlarm` ADD COLUMN `alarmType` TINYINT NOT NULL;
