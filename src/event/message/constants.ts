...
export const MESSAGE_EVENT = {
  CREATE_RESERVATION_USAGE_ALARM: 'CREATE_RESERVATION_USAGE_ALARM',
  CREATE_RESERVATION_ACCEPTED_ALARM: 'CREATE_RESERVATION_ACCEPTED_ALARM',
  CREATE_RESERVATION_REJECTED_ALARM: 'CREATE_RESERVATION_REJECTED_ALARM',
  CREATE_RESERVATION_AUTO_CANCELED_ALARM: 'CREATE_RESERVATION_AUTO_CANCELED_ALARM',
  CREATE_RESERVATION_HOST_CANCELED_ALARM: 'CREATE_RESERVATION_HOST_CANCELED_ALARM',
  CREATE_REVIEW_RECOMMEND_ALARM: 'CREATE_REVIEW_RECOMMEND_ALARM',
  CREATE_COUPON_DURATION_ALARM: 'CREATE_COUPON_DURATION_ALARM',
  CREATE_QNA_ANSWER_ALARM: 'CREATE_QNA_ANSWER_ALARM',
  CREATE_REVIEW_ANSWER_ALARM: 'CREATE_REVIEW_ANSWER_ALARM',
  CREATE_MARKETING_ALARM: 'CREATE_MARKETING_ALARM',
} as const;
