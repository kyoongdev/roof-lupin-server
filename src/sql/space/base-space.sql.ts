...
export class BaseSpaceSQL {
  ...
  getBaseSelect = () => {
    ...
    sp.updatedAt as updatedAt, sp.deletedAt as deletedAt, sp.isApproved as isApproved, sp.isPublic as isPublic, sp.orderNo as orderNo, sp.isOfficialHolidayRest as isOfficialHolidayRest,
