...
import { TransportationDTO, TransportationDTOProps } from '@/modules/space/dto/transportaion';

export interface ReviewSpaceDTOProps {
  id: string;
  title: string;
  averageScore: number;
  reviewCount: number;
...
export class ReviewSpaceDTO {
  ...
  constructor(props: ReviewSpaceDTOProps) {
