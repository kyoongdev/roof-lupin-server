...
export const HOST_ALREADY_EXIST = '이미 존재하는 호스트입니다.' as const;
...
export const HOST_TAX_RETURN_FIND_FORBIDDEN = '본인의 세금신고만 조회가 가능합니다.' as const;
export const HOST_SPACE_HOLIDAY_NOT_FOUND = '공간 휴무일을 찾을 수 없습니다.' as const;
