...
export const HOME_CATEGORY_ICON_PATH_BAD_REQUEST = '홈 카테고리는 iconId가 필수입니다.' as const;
export const CONTENT_CATEGORY_NOT_FOUND = '콘텐츠 카테고리를 찾을 수 없습니다.' as const;
export const CONTENT_CATEGORY_SPACE_NOT_FOUND = '콘텐츠 카테고리의 공간을 찾을 수 없습니다.' as const;
